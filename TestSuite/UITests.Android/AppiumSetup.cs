...
public class AppiumSetup
{
	...
	public void RunBeforeAnyTests()
	{
		...
		var androidOptions = new AppiumOptions
		{
			...
			// App = Path.Join(TestContext.CurrentContext.TestDirectory, "../../../../TestSuite/bin/Release/net10.0-android/com.companyname.testsuite-Signed.apk"),
		...
		androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppPackage, "com.companyname.testsuite");

		//Make sure to set [Register("com.companyname.testsuite.MainActivity")] on the MainActivity of your android application
		androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppActivity, $"com.companyname.testsuite.MainActivity");
